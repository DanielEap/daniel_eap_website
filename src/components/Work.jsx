        ...
        <div name='work' className='w-full lg:h-full md:h-screen md:py-12 text-gray-300 bg-gradient-to-r from-[#7DC3AF] to-[#069B9D] '>
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                        ...
                        <div className='opacity-0 group-hover:opacity-100'>
                            ...
                            <div className='pt-8 text-center'>
                                <div className='flex flex-row justify-center items-center'>
                                    <a href="https://youtu.be/V3fuKh7vUsM" target='_blank'>
                    ...
                    {/* Arduino */}
                    <div style={{ backgroundImage: `url(${ArduinoImg})` }} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
                        {/* hover effects */}
                        <div className='opacity-0 group-hover:opacity-100'>
                            <div className='text-center'>
                                <span className='text-2xl text-justify font-bold text-white tracking-wider'>
                            ...
                            <div className='pt-8 text-center'>
                                <div className='flex flex-row justify-center items-center'>
                                    <a href="https://youtu.be/hYw2fypCzV4" target='_blank'>
                                        <span className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-[#c38d93]'>
                                            Demo
                                            <TbExternalLink className='inline-block ml-2' />
                                        </span>
                                    </a>
                                    <a href="https://github.com/DanielEap/OPSArduino" target='_blank'>
                                        <span className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-[#c38d93]'>
                                            Code
                                            <TbExternalLink className='inline-block ml-2' />
                                        </span>
